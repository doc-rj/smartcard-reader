...
public class AnimatedExpandableListView extends ExpandableListView {
     ...
     * child memberApps, giving up no chance to do any sort of animation. Instead
    ...
    public boolean expandGroupWithAnimation(int groupPos) {
        ...
        // TODO: removed this block as all seems good without it; it was causing null view
        // and crash when expanding a group at the bottom of display, when (group - 1) was
        // expanded with only children showing; in that case, getFirstVisiblePosition() was
        // larger than groupFlatPos and so childIndex was negative
    	/*
    ...
    public int getFirstVisibleGroup() {
        ...
        long packedPosition = getExpandableListPosition(firstVis);
        ...
        public final View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, final ViewGroup parent) {
            ...
            if (info.animating) {
                ...
                if (childPosition < info.firstChildPosition) {
                    ...
                    // refreshed. Now the problem is, if a group has 2 memberApps
